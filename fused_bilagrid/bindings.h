...
// Fast versions with optimizations
...
// Fast optimized tensor wrappers
torch::Tensor bilagrid_sample_forward_fast_tensor(
    torch::Tensor bilagrid, // [N,12,L,H,W]
    torch::Tensor coords,  // [N,m,h,w,2]
    torch::Tensor rgb  // [N,m,h,w,3]
) {
...
std::tuple<torch::Tensor, std::optional<torch::Tensor>, torch::Tensor>
bilagrid_sample_backward_fast_tensor(
    torch::Tensor bilagrid,  // [N,12,L,H,W]
    torch::Tensor coords,  // [N,m,h,w,2]
    torch::Tensor rgb,  // [N,m,h,w,3]
    torch::Tensor v_output,  // [N,m,h,w,3]
...
// New optimized versions tensor wrappers
...
std::tuple<torch::Tensor, std::optional<torch::Tensor>, torch::Tensor>
bilagrid_sample_backward_hierarchical_tensor(
    torch::Tensor bilagrid,  // [N,12,L,H,W]
    torch::Tensor coords,  // [N,m,h,w,2]
    torch::Tensor rgb,  // [N,m,h,w,3]
    torch::Tensor v_output,  // [N,m,h,w,3]
    ...
    if (compute_coords_grad) {
        ...
        return std::make_tuple(v_bilagrid, std::nullopt, v_rgb);
    }
}
